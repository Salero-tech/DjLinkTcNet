...
class MetaData:
    ...
    def __init__(self, layerId, trackArtist, trackTitle, trackKey, trackId) -> None:
        self.dataType = 4
    ...
    def getBytes (self):
        ...
        #reserved
        res.append(b'\x00'*3)
        res.append(addZeroBytes(self.trackArtist.encode("utf-8"), 256))
        res.append(addZeroBytes(self.trackTitle.encode("utf-8"), 256))
        res.append(intToLittleEndian(self.trackKey, 2))
